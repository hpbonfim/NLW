...
const OrphanageDetailsLoading = (props: any) => {
  ...
  return (
    <ContentLoader
      ...
      backgroundColor={title === "light" ? "#ffffff" : "#222"}
      foregroundColor={title === "light" ? "#e8e8e8" : "#333"}
      {...props}
    >
...
export default OrphanageDetailsLoading;
