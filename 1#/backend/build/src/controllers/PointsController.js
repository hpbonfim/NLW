...
var host = __importStar(require("../config/dev"));
var PointsController = /** @class */ (function () {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image_url: "http://" + host.default.host_dev + ":3333/uploads/" + point.image });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        ;
                        serializedPoint = __assign(__assign({}, point), { image_url: "http://" + host.default.host_dev + ":3333/uploads/" + point.image });
    ...
    PointsController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, email, whatsapp, latitude, longitude, city, uf, items //
            , transaction, pointData, insertedIds, point_id, pointItems;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, transaction('points').insert(pointData)];
                    case 2:
                        insertedIds = _b.sent();
                    ...
                    case 4:
                        _b.sent();
                        return [2 /*return*/, response.json(__assign({ id: point_id }, pointData))];
                }
            });
        });
    };
